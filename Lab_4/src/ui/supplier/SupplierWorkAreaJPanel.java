...
public class SupplierWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public SupplierWorkAreaJPanel(JPanel mainWorkArea, Supplier supplier) {
        ...
        if (supplier != null) lblWelcome.setText("Welcome to Lab 4 by Krisha, "+supplier.getSupplyName());
    }
    ...
    private void btnSupplierProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupplierProfileActionPerformed
        // TODO add your handling code here:
        UpdateSupplier updateSupplierPanel = new UpdateSupplier(workArea, supplier);
        workArea.add("UpdateSupplier", updateSupplierPanel);
        CardLayout layout = (CardLayout) workArea.getLayout();
        layout.next(workArea);
